...
public class InstructionStep : MonoBehaviour
{
    ...
    public virtual void OnEnable()
    {
        if (useGeneratedInstruction)
        {
            ...
            if(InstructionGenerator.instance.generatedInstructions.TryGetValue(componentType, out instruction))
            {
                OnInstructionUpdated.Invoke(this);
            }
            else
            {
                InstructionGenerator.OnNewInstructionGenerated.AddListener(OnNewInstructionGenerated);
            }
